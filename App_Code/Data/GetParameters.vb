...
Namespace DataLayer
    Public Class Parameters
        Public Function GetAllParameters(ByVal ProcedureName As String) As IList(Of ModelLayer.Parameter)
            ...
            Dim reader As New SafeDataReader(dal.getSpReader("AdminTool.GetAllParametersForProcedure", params.ToArray))
            While reader.Read
        ...
        Public Function GetExtendedPropertiesForProcedureParameter(ByVal procedureName As String, ByVal paramaterName As String) As NameValueCollection
            ...
            Dim reader As New SafeDataReader(dal.getSpReader("AdminTool.GetExtendedPropertiesForProcedureParameter", params.ToArray))
            While reader.Read
